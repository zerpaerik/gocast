...
export let badgeTS2 = `  <span class="badge bg-primary-transparent">Primary</span>
...
export let badgeTS4 = ` <span class="badge bg-outline-primary">Primary</span>
...
export let badgeTS5 = `  <span class="badge rounded-pill bg-outline-primary">Primary</span>
...
export let badgeTS6 = `  <span class="badge bg-primary-gradient">Primary</span>
...
export let badgeTS7 = ` <span class="badge rounded-pill bg-primary-gradient">Primary</span>
...
export let badgeTS8 = `    <button type="button" class="btn btn-danger my-1 me-2">
