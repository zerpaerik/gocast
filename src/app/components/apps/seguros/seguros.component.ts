...
export class SegurosComponent {
 ...
 borderColumn=[
  {header:"Nombre de compañia",field:"nombre"},         
  {header:"R.I.F",field:"rif"},
  {header:"Estatus",field:"status"},
  {header:"Acciones",field:"accion"},



 ]
 borderTables=[
 {nombre:"Caracas",rif: "J-00232438434",status:"Activo",bg:"success"},
 {nombre:"Previsora",rif: "J-00232438434",status:"Activo",bg:"success"},
 {nombre:"Oceanica",rif: "J-00232438434",status:"Activo",bg:"success"},
