...
export class PopoversComponent {
  ...
  coloredPopovers = [
    ...
    { id: 2, header: "header-primary1",  class: 'primary1', title: 'colored header', title1: "Header Primary1", content: "Popover with primary header.", textcolor: "" },
    { id: 3, header: "header-primary2",  class: 'primary2', title: 'colored header', title1: "Header Primary2", content: "Popover with primary header.", textcolor: "" },
    { id: 4, header: "header-primary3",  class: 'primary3', title: 'colored header', title1: "Header Primary3", content: "Popover with primary header.", textcolor: "" },
  ...
  coloredBackground = [
    ...
    { id: 1, header: "Color Background",class:"btn btn-primary1 btn-wave",popoverClass:"popover-primary1", title: "Primary1",  content: "Popover with Primary background.", color: "primary", textcolor: ""},
    { id: 1, header: "Color Background",class:"btn btn-primary2 btn-wave",popoverClass:"popover-primary2", title: "Primary2",  content: "Popover with Primary background.", color: "primary", textcolor: ""},
    { id: 1, header: "Color Background",class:"btn btn-primary3 btn-wave",popoverClass:"popover-primary3", title: "Primary3",  content: "Popover with Primary background.", color: "primary", textcolor: ""},
  ...
  lightPopovers = [
    ...
    { id: 1, header: "Color Background",class:"btn btn-primary1-light btn-wave waves-effect waves-light",popoverClass:"popover-primary1-light", title: "Primary1",  content: "Popover with Primary background.", color: "primary", textcolor: ""},
    { id: 1, header: "Color Background",class:"btn btn-primary2-light btn-wave waves-effect waves-light",popoverClass:"popover-primary2-light", title: "Primary2",  content: "Popover with Primary background.", color: "primary", textcolor: ""},
    { id: 1, header: "Color Background",class:"btn btn-primary3-light btn-wave waves-effect waves-light",popoverClass:"popover-primary3-light", title: "Primary3",  content: "Popover with Primary background.", color: "primary", textcolor: ""},
  ...
  SvgPopover = [
    { id: 1,
      class:'popover-primary only-body',svg:'<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none" /><path d="M11 18h2v-2h-2v2zm1-16C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm0-14c-2.21 0-4 1.79-4 4h2c0-1.1.9-2 2-2s2 .9 2 2c0 2-3 1.75-3 5h2c0-2.25 3-2.5 3-5 0-2.21-1.79-4-4-4z" /></svg>',
