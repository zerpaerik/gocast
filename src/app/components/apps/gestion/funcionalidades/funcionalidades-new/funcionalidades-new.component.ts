...
@Component({
  selector: 'new-funcionalidad',
  standalone: true,
  imports: [SharedModule,ShowcodeCardComponent],
  templateUrl: './funcionalidades-new.component.html',
  styleUrl: './funcionalidades-new.component.scss'
})
export class FuncionalidadesNewComponent {
