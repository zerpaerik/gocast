  ...
  borderCards = [
    {
      ...
      badges: ['Framework', 'Angular', 'Php'],
      badgeClasses: ['bg-primary1-transparent', 'bg-secondary-transparent', 'bg-info-transparent'],
      avatars: ['./assets/images/faces/2.jpg', './assets/images/faces/8.jpg', './assets/images/faces/2.jpg']
    }, 
    {
      title: 'Home Page Design',
      iconClass: 'text-primary2',
      borderClass: 'border-primary2',
      badges: ['Framework', 'Angular', 'Php'],
      badgeClasses: ['bg-primary2-transparent', 'bg-secondary-transparent', 'bg-info-transparent'],
      avatars: ['./assets/images/faces/2.jpg', './assets/images/faces/8.jpg', './assets/images/faces/2.jpg']
    }, {
      title: 'Home Page Design',
      ...
      badges: ['Framework', 'Angular', 'Php'],
      badgeClasses: ['bg-primary3-transparent', 'bg-secondary-transparent', 'bg-info-transparent'],
      avatars: ['./assets/images/faces/2.jpg', './assets/images/faces/8.jpg', './assets/images/faces/2.jpg']
    },
    {
